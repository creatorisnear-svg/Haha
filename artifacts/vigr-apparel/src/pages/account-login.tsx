    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          ...
          <h1 className="font-display text-4xl tracking-widest uppercase mt-6">Sign In</h1>
          <p className="text-muted-foreground mt-2 font-sans text-sm tracking-wide">Access your account & orders</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground font-sans">
          No account?{" "}
          <Link href={`/account/register?redirect=${encodeURIComponent(redirect)}`} className="text-foreground hover:text-primary underline underline-offset-4 transition-colors">
            Create one
          </Link>
        </p>
      </div>
